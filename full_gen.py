...
def gen_begining(configlist,path):
    ...
    for line in configlist:
        if line.find("primary 10/2\n")==-1:
            ...
            cmdlist.append('/configure application-assurance group 1:1 policy app-profile "default-app-profile" create description "Global App-profile"\n')
